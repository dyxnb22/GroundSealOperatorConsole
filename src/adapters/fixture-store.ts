...
import { ApprovalQueueQuerySchema } from "../contracts/approval.js";
...
import { transitionApprovalStatus } from "../core/approval-state-machine.js";
...
function seedData(): { approvals: InternalApproval[]; runs: InternalRun[] } {
  return {
    approvals: [
      {
        approvalId: "apr-001",
